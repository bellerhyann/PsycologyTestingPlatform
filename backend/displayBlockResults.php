...
//create query
$queryString = "SELECT BO, stimIDOne, stimIDTwo, isCorrect, clicked, clickTime, phaseID, userID FROM trial_T, dataBlock WHERE trial_T.trialID = dataBlock.trialID ORDER BY phaseID, userID, BO";
//run query
