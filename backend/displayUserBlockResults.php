...
$createView = "create view dataUserBlock if not exists AS SELECT * FROM data_T WHERE blockID = $blockID AND userID = $userID";
//run query
$result =  mysqli_query($conn, $createView);

//create query
$queryString = "SELECT stimIDOne, stimIDTwo, isCorrect, clicked, clickTime, phaseID FROM trial_T, dataUserBlock WHERE trialID.trial_T = trialID.dataUserBlock GROUP BY phaseID";
//run query
...
//delete view
$dropView = "DROP VIEW[dataUserBlock]";
